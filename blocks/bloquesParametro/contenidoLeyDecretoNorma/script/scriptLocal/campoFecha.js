...
//	
//	campoFechaFin[IFechaFinA++] = "#<?php echo $this->campoSeguro('fechaVen')?>";
//	campoFechaInputFin[IFechaFinB++] = "input#<?php echo $this->campoSeguro('fechaVen')?>";
//	
