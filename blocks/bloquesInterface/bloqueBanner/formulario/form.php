...
namespace bloquesModelo\bloqueBanner\formulario;
...
// 		$_REQUEST ['tiempo'] = time ();
        ...
        unset($atributos);
	        ...
	        unset($atributos);
		        ...
		        $atributos ["imagen"] = $rutaBloque . "/css/imagenes/titan.png";
		        $atributos ['alto'] = 120;
		        $atributos ['ancho'] = 380;
		        $atributos ["borde"] = 0;
        	...
        	echo $this->miFormulario->division("fin");
	      	...
	      	unset($atributos);
		      	...
		      	$esteCampo = 'campoCargo';
		      	$atributos ["id"] = $esteCampo;
		      	$atributos ["estilo"] = $esteCampo;
		      	$atributos ['columnas'] = 1;
		      	$atributos ["estilo"] = $esteCampo;
		      	$atributos ['texto'] = 'Cargo: ---'; // Aqui se deberealizar la consulta  para mostrar el usuario del sistema.
		      	$atributos ['tabIndex'] = $tab++;
		      	echo $this->miFormulario->campoTexto($atributos);
		      	unset($atributos);
