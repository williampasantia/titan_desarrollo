	...
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
       ...
       $longitud = count($matrizItems);
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."NIT".'</th><th>'."NOMBRE".'</th> <th>'."DESCRIPCION".'</th> <th>'."NATURALEZA".'</th> <th>'."REGLAENTACION".'</th><th>'."OPCIONES POR REGISTRO".'</th></tr></thead>
