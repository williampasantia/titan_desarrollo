...
class Formulario {
	...
	$atributos ['tipoEtiqueta'] = 'inicio';
	$atributos ["leyenda"] = "VINCULACION PERSONA NATURAL";
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
       ...
       $longitud = count($matrizItems);
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."DOCUMENTO".'</th><th>'."NOMBRE".'</th> <th>'."APELLIDO".'</th> <th>'."AUTORRETENEDOR".'</th><th>'."REGIMEN".'</th><th>'."OPCIONES POR REGISTRO".'</th></tr></thead>
