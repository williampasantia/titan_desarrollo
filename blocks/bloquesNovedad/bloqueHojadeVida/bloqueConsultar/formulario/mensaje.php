		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if ($_REQUEST ['mensaje'] == 'noInserto') {
					...
					$mensaje = "No Se Pudo Hacer Modificación Funcionario <br> Nombres: " . $_REQUEST ['primerNombre'] . " ".$_REQUEST ['segundoNombre'].
				...
				if ($_REQUEST ['mensaje'] == 'noInsertoVal') {
					...
					"<br>Fecha Registro:" . date ( 'Y-m-d' ).
					"<br>".
					"<br>La Modificación No se Pudo Completar Debido a que no se Completo algun Campo Requerido en los Campos Dinamicos";
			...
			// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
			$esteCampo = 'funcionarioRegistrosReferenciasCAOS';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
