...
class Formulario {
	...
	function formulario() {
		...
		*/
		...
		echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> ' . '<thead style="display: table-row-group"><tr><th>' . "CÓDIGO" . '</th><th>' . "NOMBRE" . '</th><th>' . "DESCRIPCIÓN" . '</th> <th>' . "ESTADO" . '</th></tr></thead>
