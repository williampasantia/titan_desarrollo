	...
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
        ...
        $resultado=$primerRecursoDB->ejecutarAcceso($atributos['cadena_sql'], "busqueda");
         ...
         // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                ...
                $_REQUEST['concepto'] =  $resultado[$_REQUEST['variable']]['concepto'];
                
                $_REQUEST['tipoVinculacion'] =  $resultado[$_REQUEST['variable']]['tipo_vinculacion'];
		$_REQUEST['tipoNomina'] =  $resultado[$_REQUEST['variable']]['tipo_nomina'];
...
// ---------------- CONTROL: Select --------------------------------------------------------
            ...
            'tipo_vinculacion' => $_REQUEST ['tipoVinculacion']
                  ...
                  $atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarIdTipoVinculacion",$datos );
	        
                  
                  $matrizItems = $primerRecursoDB->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
	        
	        if (isset ( $_REQUEST [$esteCampo] )) {
	        	$atributos ['seleccion'] =  $matrizItems[0][0];
	        } else {
	        	$atributos ['valor'] = '';
	        }
	        $tab ++;
	   ...
	   $datos = array(
            'tipo_nomina' => $_REQUEST ['tipoNomina']
                  ...
                  $atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarIdNomina",$datos );
	        ...
	        if (isset ( $_REQUEST [$esteCampo] )) {
	        	$atributos ['seleccion'] = $matrizItems1 [0][0];
	        } else {
	        	$atributos ['valor'] = '';
	        }
	        $tab ++;
