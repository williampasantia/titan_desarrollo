...
class Formulario {
	...
	$atributos ['tipoEtiqueta'] = 'inicio';
	$atributos ["leyenda"] = "GESTION PERSONA NATURAL";
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."DOCUMENTO".'</th><th>'."1 NOMBRE".'</th> <th>'."2 NOMBRE".'</th> <th>'."1 APELLIDO".'</th> <th>'." 2 APELLIDO".'</th><th>'."REGIMEN".'</th><th>'."ESTADO".'</th><th>'."VER DETALLE".'</th><th>'."MODIFICAR".'</th><th>'."APROBAR".'</th></tr></thead>
