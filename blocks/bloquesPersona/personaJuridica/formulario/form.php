...
class Formulario {
	...
	$atributos ['tipoEtiqueta'] = 'inicio';
	$atributos ["leyenda"] = "GESTION PERSONA JURÍDICA";
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
        ...
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("buscarRegistroxPersona");
//         var_dump($atributos);exit;
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."DOCUMENTO".'</th><th>'."RAZÓN SOCIAL".'</th> <th>'."AUTORRETENEDOR".'</th> <th>'."COMPUESTO".'</th> <th>'."ESTADO".'</th><th>'."VER DETALLE".'</th><th>'."MODIFICAR".'</th><th>'."ACTIVAR".'</th></tr></thead>
